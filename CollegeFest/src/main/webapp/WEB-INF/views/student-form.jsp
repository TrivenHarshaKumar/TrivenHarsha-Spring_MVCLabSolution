...
<body>
	<div class="container p-3 my-3 bg-primary text-white">
		<h1 style="text-align: center">SASTRA Deemed to be University</h1>
		...
		<div class="container">
			<h4 style="text-align: center;">College Fest Registraion Form</h4>
			<div class="row">
					...
					<form action="save" method="post">
						...
						<div class="form-group">
							<input type="text" class="form-control"
								placeholder="Please Enter Department" name="department"
